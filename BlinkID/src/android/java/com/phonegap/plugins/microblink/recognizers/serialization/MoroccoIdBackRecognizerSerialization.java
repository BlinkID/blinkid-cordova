...
public final class MoroccoIdBackRecognizerSerialization implements RecognizerSerialization {
    ...
    public Recognizer<?, ?> createRecognizer(JSONObject jsonRecognizer) {
        ...
        recognizer.setExtractCivilStatusNumber(jsonRecognizer.optBoolean("extractCivilStatusNumber", true));
        recognizer.setExtractDateOfExpiry(jsonRecognizer.optBoolean("extractDateOfExpiry", true));
        recognizer.setExtractFathersName(jsonRecognizer.optBoolean("extractFathersName", true));
        recognizer.setExtractMothersName(jsonRecognizer.optBoolean("extractMothersName", true));
    ...
    public JSONObject serializeResult(Recognizer<?, ?> recognizer) {
        ...
        try {
            ...
            jsonResult.put("civilStatusNumber", result.getCivilStatusNumber());
