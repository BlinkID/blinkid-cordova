...
-(NSDictionary *) serializeResult {
    ...
    [jsonResult setObject:[MBBlinkIDSerializationUtils serializeMRZResult:self.result.mrzResult] forKey:@"MRZResult"];
    [jsonResult setObject:[MBSerializationUtils encodeMBImage:self.result.fullDocumentImage] forKey:@"fullDocumentImage"];
